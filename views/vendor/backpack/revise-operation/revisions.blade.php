...
@php
    ...
    $subheading = $crud->getSubheading() ?? method_exists($entry, 'identifiableName') ? trans('revise-operation::revise.revisions_for').' "<strong>'.$entry->identifiableName().'</strong>"' : trans('revise-operation::revise.revisions');
@endphp
